...
describe('satel-integra-decoder Node', function () {
  ...
  it('should be loaded', function () {
    return new Promise(function (resolve, reject) {
      const flow = [{ id: "n1", type: "satel-integra-decoder", name: "Decoder" }];
  ...
  it('should issue error on message without payload', function () {
    return new Promise(function (resolve, reject) {
      ...
      const flow = [
        ...
        { id: "n1", z: "f1", type: "satel-integra-decoder", name: "Decoder", wires: [["n2"]] },
        ...
        helperNode2.on("input", function (msg) {
          try {
            ...
            msg.error.should.have.property(
                "source", { id: 'n1', type: 'satel-integra-decoder', name: 'Decoder', count: 1});
            resolve();
          } catch(error) {
            reject(error);
          }
  ...
  it('should pass frame to decodeMessage function', function () {
    ...
    return new Promise(function (resolve) {
      sinon.replace(protocol, "decodeMessage", sinon.fake.returns(new protocol.NewDataAnswer()));
      const flow = [
        { id: "n1", type: "satel-integra-decoder", name: "Decoder", wires:[["n2"]] },
        { id: "n2", type: "helper" }
      ];
      helper.load(decoder, flow, function () {
        const decoderNode = helper.getNode("n1"); 
