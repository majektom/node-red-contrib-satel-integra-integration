...
describe('satel-integra-encoder Node', function () {
  ...
  it('should be loaded', function () {
    return new Promise(function (resolve, reject) {
      const flow = [{ id: "n1", type: "satel-integra-encoder", name: "Encoder" }];
  ...
  it('should issue error on message without topic', function () {
    return new Promise(function (resolve, reject) {
      const flow = [
        ...
        { id: "n1", z: "f1", type: "satel-integra-encoder", name: "Encoder", wires: [["n2"]] },
      ...
      helper.load([encoder, catchNode], flow, function () {
        ...
        helperNode2.on("input", function (msg) {
          try {
            ...
            msg.error.should.have.property(
                "source", { id: 'n1', type: 'satel-integra-encoder', name: 'Encoder', count: 1});
            resolve();
          } catch(error) {
            reject(error);
          }
  ...
  it('should properly encode new_data command', function () {
    return new Promise(function (resolve, reject) {
      const flow = [
        { id: "n1", type: "satel-integra-encoder", name: "Encoder", wires: [["n2"]] },
        { id: "n2", type: "helper" }
      ];
      helper.load([encoder, catchNode], flow, function () {
        const encoderNode = helper.getNode("n1");
        ...
        helperNode.on("input", function (msg) {
          try {
            ...
            msg.should.have.property("payload", new protocol.NewDataCommand().encode());
            resolve();
          } catch(error) {
            reject(error);
          }
      ...
      helper.load([encoder, catchNode], flow, function () {
        ...
        helperNode.on("input", function (msg) {
          try {
            ...
            msg.should.have.property("payload", new protocol.OutputsStateCommand().encode());
            resolve();
          } catch(error) {
            reject(error);
          }
      ...
      helper.load([encoder, catchNode], flow, function () {
        ...
        helperNode.on("input", function (msg) {
          try {
            ...
            msg.should.have.property("payload", new protocol.ZonesTamperCommand().encode());
            resolve();
          } catch(error) {
            reject(error);
          }
      ...
      helper.load([encoder, catchNode], flow, function () {
        ...
        helperNode.on("input", function (msg) {
          try {
            ...
            msg.should.have.property("payload", new protocol.ZonesViolationCommand().encode());
            resolve();
          } catch(error) {
            reject(error);
          }
